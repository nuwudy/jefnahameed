<div class="bg-white border border-stone-200 rounded-3xl p-6 sm:p-10 shadow-md">
    @if($isSuccess)
        <div class="text-center py-8">
            ...
            <h3 class="font-serif text-2xl font-semibold text-[#3B4E3B] mb-2">Message Sent Confidentially</h3>
            ...
            <button type="button" wire:click="resetForm" class="px-6 py-2.5 bg-[#3B4E3B] text-white rounded-xl text-xs font-medium hover:bg-[#2A382A] transition">
        ...
        <form wire:submit="submit" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" wire:model="name" placeholder="Full name" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
                ...
                <div>
                    ...
                    <input type="tel" wire:model="phone" placeholder="+91 98765 43210" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" wire:model="email" placeholder="you@example.com" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
                ...
                <div>
                    ...
                    <select wire:model="service_type" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
                        <option value="Family & Couple Counselling">Family & Couple Counselling (ഭാര്യയും ഭർത്താവും)</option>
                        <option value="1-on-1 Clinical Therapy">1-on-1 Clinical Therapy</option>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select wire:model="preferred_slot" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
                ...
                <div>
                    ...
                    <select wire:model="session_mode" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]">
            ...
            <div>
                ...
                <textarea wire:model="message" rows="3" placeholder="Describe your concern or goals confidentially..." class="w-full px-4 py-2.5 rounded-xl border border-stone-300 bg-[#FAF8F5] text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#3B4E3B]"></textarea>
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit" wire:loading.attr="disabled" class="px-8 py-3 bg-[#3B4E3B] hover:bg-[#2A382A] text-white font-medium text-sm rounded-xl transition shadow-md">
