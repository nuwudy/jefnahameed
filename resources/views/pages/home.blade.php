            ...
            <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
                    <button type="button"
                            ...
                            class="w-full sm:w-auto px-7 py-3.5 bg-[#54321A] hover:bg-[#3B2110] text-[#FAF6F0] font-semibold text-xs sm:text-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer border border-[#DFB254]/40">
                    ...
                    <a href="https://wa.me/918590415943?text=Hello%20Jefna%20Hameed,%20I%20would%20like%20to%20inquire%20about%20a%20confidential%20marriage%20guidance%20session."
                       ...
                       class="w-full sm:w-auto px-6 py-3.5 bg-[#25D366] hover:bg-[#20ba5a] text-white font-semibold text-xs sm:text-sm rounded-2xl shadow-sm hover:shadow-md transition text-center flex items-center justify-center gap-2">
                    ...
                    <a href="{{ route('blog.index') }}"
                       class="w-full sm:w-auto px-5 py-3.5 bg-white hover:bg-[#FAF2DE] text-[#54321A] font-semibold text-xs sm:text-sm rounded-2xl border border-[#DFB254]/40 shadow-xs hover:shadow-sm transition text-center flex items-center justify-center gap-1.5">
                        <span>📖 Read Blog</span>
                    </a>
                </div>
                    ...
                    <div class="relative rounded-3xl bg-[#FCFAF7] border-2 border-[#DFB254]/40 p-2 sm:p-2.5 shadow-2xl overflow-hidden group ambient-warm-glow">
                        <div class="relative w-full aspect-square rounded-2xl overflow-hidden bg-[#FAF6F0] shadow-inner">
                            ...
                            <button type="button"
                                    ...
                                    class="absolute left-2.5 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#54321A]/85 hover:bg-[#3B2110] text-[#FAF6F0] border border-[#DFB254]/50 flex items-center justify-center text-sm shadow-lg transition transform hover:scale-105 active:scale-90 z-20 cursor-pointer backdrop-blur-xs">
                                ❮
                            </button>
                            <button type="button"
                                    @click="next()"
                                    aria-label="Next Slide"
                                    class="absolute right-2.5 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#54321A]/85 hover:bg-[#3B2110] text-[#FAF6F0] border border-[#DFB254]/50 flex items-center justify-center text-sm shadow-lg transition transform hover:scale-105 active:scale-90 z-20 cursor-pointer backdrop-blur-xs">
                                ❯
                            </button>
