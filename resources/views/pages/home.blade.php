    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <!-- Mobile Only Hero Image Slider (Positioned between Headline and Subheadline) -->
                <div class="block lg:hidden my-6 max-w-sm sm:max-w-md mx-auto">
                    <x-hero-slider class="w-full" />
                </div>
            ...
            <!-- Right Visual Hero Slider Carousel Column (5 cols - Desktop only) -->
            <div class="hidden lg:block lg:col-span-5 relative">
                <x-hero-slider class="w-full max-w-lg" />
            </div>
